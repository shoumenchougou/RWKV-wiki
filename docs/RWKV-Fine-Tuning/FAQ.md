...
## After running the script to start the training, an error related to insufficient video memory (memory/VRAM) occurs.

Solution: The video memory is insufficient, and you need to upgrade the graphics card device.
